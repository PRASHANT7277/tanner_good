...
export default function Navbar(){
  ...
  <Spacer />
  <Box p='3' >
   <a href="https://www.instagram.com/tannergoods/"><GrInstagram/></a>
  </Box>
  <Box p='3' >
  <a href='https://facebook.com/tannergoods'><GrFacebookOption/></a>
  </Box>
  <Box  >
  <Select >
 ...
 <Box mb='10'><hr /></Box>
        <Flex>
  <Box  ml='20' >
   <Link to='/'><Image src='https://cdn.shopify.com/s/files/1/0044/9802/files/Tanner-Goods-Mazama-Logo_150x.png?v=1600190052' alt='..'/></Link>
  </Box>
  <Spacer />
  <Box p='3'>
  <div class="dropdown">
  <button class="dropbtn"><Link to='/'>Tanner Goods</Link></button>
  ...
  <Box p='3'>
  <div class="dropdown">
  <button class="dropbtn"><Link to='/finalsale'>Final Sale</Link></button>
