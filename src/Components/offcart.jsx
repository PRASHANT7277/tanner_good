        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
          ...
          <div class="offcanvas-body">
            ...
            <Box mt="10px" display='flex' justifyContent='space-between'>
                <Box><Text fontweight="semibold" fontSize="40px"><Link to='/cart'>Your cart</Link></Text>({qTotal()}) item</Box>
            ...
            {data.map((elem)=>
              ...
              <Box display='flex'>
                  ...
                  <Box w='200px' color='mineralgreen'><Text fontSize='18' fontWeight='semibold'>{elem.title}</Text><Text>{elem.des}</Text> <Text>₹{elem.price}</Text></Box>
              </Box>
              <Box display='flex' >
                  <Count qty={elem.qty} HandleCount={HandleCount} id={elem.id} price={elem.price} aprice={elem.aprice}/>
            ...
            <Box mb='50px' color='white' textAlign='right' mt='30px' ><Link to='/payment'><Button  bgColor='#475d4b' pt='25px' pb='25px' pl='150px' pr='150px' fontWeight='bold'><Link to='/payment'>Check out</Link></Button></Link></Box>
        </Box>
