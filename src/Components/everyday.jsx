...
export default function EverydayArrival() {
  const [data, setData] = useState();
  const [type, setType] = useState("ASC");
  function getData() {
    axios
      .get(
        `https://real-tan-adder-hose.cyclic.app/eday?_sort=price&_order=${type}`
      )
